...
v2bool  = vector_format_builder("ml_bool2_t", "bool2", 2, ML_Bool, compound_constructor = ML_IntegerVectorFormat)
v3bool  = vector_format_builder("ml_bool3_t", "bool3", 3, ML_Bool, compound_constructor = ML_IntegerVectorFormat)
v4bool  = vector_format_builder("ml_bool4_t", "bool4", 4, ML_Bool, compound_constructor = ML_IntegerVectorFormat)
v8bool  = vector_format_builder("ml_bool8_t", "bool8", 8, ML_Bool, compound_constructor = ML_IntegerVectorFormat)
