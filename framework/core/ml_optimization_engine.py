    ...
    def fuse_multiply_add(self, optree, silence = False, memoization = {}):
        ...
        if isinstance(optree, Addition) or isinstance(optree, Subtraction):
            if len(optree.inputs) != 2:
                ...
                if optree in memoization: 
                ...
                elif self.get_dot_product_enabled() and isinstance(optree.inputs[0], Multiplication) and isinstance(optree.inputs[1], Multiplication):
                    ...
                    return new_op
                elif isinstance(optree.inputs[0], Multiplication):
                ...
                elif isinstance(optree.inputs[1], Multiplication):
