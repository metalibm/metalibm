...
FUNCTION_NAME=new_log2
MPFR_FUNC_NAME=mpfr_log2
FUNCTION_FILE=new_log2.c
...
if [ -z $SUP_INTERVAL ]; then SUP_INTERVAL=1.5; fi
 ...
 &&  python $ML_DIR/framework/ml_functions/ml_log2.py --target k1b --output $FUNCTION_FILE $EXTRA_GEN_OPTIONS --fname $FUNCTION_NAME --precision binary64 \
